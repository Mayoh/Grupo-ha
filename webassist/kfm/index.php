...
<html>
	<head>
    <link type="text/css" rel="stylesheet" href="//ajax.googleapis.com/ajax/libs/jqueryui/1.7.2/themes/ui-lightness/jquery-ui.css" />
...
// { once per day, tell the kfm website a few simple details about usage
	if (!$kfm_dont_send_metrics) {
		echo '<img src="//kfm.verens.com/extras/register.php?version='.urlencode(KFM_VERSION).
